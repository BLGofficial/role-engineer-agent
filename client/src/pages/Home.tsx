...
export default function Home() {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      folder.file("evaluator_checklist.md", `# Checklist\n\n${roleData.evaluatorChecklist.map((c: string) => `- [ ] ${c}`).join("\n")}`);
        ...
        <div className="flex-1 flex flex-col overflow-hidden w-full">
          ...
          <div className="flex-1 overflow-y-auto p-4 sm:p-8">
            <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
              {/* Input Section */}
              <GlassCard className="p-4 sm:p-8 animate-slide-up glow" glow>
              ...
              {/* Loading */}
              {loading && (
                <GlassCard className="p-8 sm:p-12 flex justify-center animate-slide-up glow" glow>
              ...
              {/* Pipeline Tracker */}
              {roleData && (
                <GlassCard className="p-4 sm:p-6 animate-slide-up overflow-x-auto glow" glow>
              ...
              {roleData && (
                <>
                  ...
                  <GlassCard className="p-4 sm:p-6 animate-slide-up glow" glow>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    <GlassCard className="p-4 sm:p-6 animate-slide-up glow [animation-delay:0.25s]" glow>
                      ...
                      <div className="space-y-2">
                        {roleData.evaluatorChecklist.map((item: string, i: number) => (
                  ...
                  {/* Export Card */}
                  <GlassCard className="p-4 sm:p-8 border-orange-400/50 bg-gradient-to-r from-orange-500/20 to-orange-400/10 animate-slide-up glow" glow>
